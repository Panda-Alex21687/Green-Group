...
# ----------------------------
# CONNECT TO DATABASE
# Making connection to outland database 
# ----------------------------
...
# REquired busness decision: replacing equipment after 5 years
# Query to serch inventory and inform of equipment to replace
# -------------------------------------------
...
# required business decision to identify which regions have declining interest 
# shows total booking per region 
# -------------------------------------------
...
# Third required business decision that checks equipment inventory based on sales vs rentals
# -------------------------------------------
...
# Additional report to show guide workloads 
# shows how many trips each guide takes 
...
# Additional report to identify popular equipmnent sales and rentals 
# Identifies which equipment generates most revenue 
